    ...
    <div className='bg-[#111] text-white p-6 sm:p-10 md:p-14'>
      <div className='max-w-120'>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-3 sm:gap-6 md:gap-9 w-full mt-6 sm:mt-8 text-[12px] sm:text-[14px] md:text-[16px]">
          <button className="bg-[#c9f31d] px-7 sm:px-9 md:px-12 py-2 sm:py-2.5 md:py-3 text-[#070707] font-[600] rounded-[12px] sm:rounded-[15px] cursor-pointer hover:bg-[#b4da1a] hover:transition-all duration-300"
            onClick={() => {
